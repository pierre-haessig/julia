...
JL_DLLEXPORT jl_value_t *jl_get_nth_field_noalloc(jl_value_t *v PROPAGATES_ROOT, size_t i) NOTSAFEPOINT;
...
JL_DLLEXPORT jl_value_t *jl_ptrarrayref(jl_array_t *a PROPAGATES_ROOT, size_t i) NOTSAFEPOINT;  // 0-indexed
