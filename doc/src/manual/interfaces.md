...
Additionally, to support the syntax `S[end]`, we must define [`endindex`](@ref) to specify the last
valid index. It is recommended to also define [`beginindex`](@ref) to specify the first valid index:
